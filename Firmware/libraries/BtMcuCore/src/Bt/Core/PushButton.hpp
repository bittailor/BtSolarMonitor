...
#ifndef INC__Bt_Core_PushButton__hpp
#define INC__Bt_Core_PushButton__hpp
...
class PushButton : public StateMachine<I_PushButton,PushButton>
{
   public:
...
#endif // INC__Bt_Core_PushButton__hpp
