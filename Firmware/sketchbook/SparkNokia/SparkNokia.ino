...
const int scePin = A4;   // SCE - Chip select, pin 3 on LCD.
const int rstPin = A3;   // RST - Reset, pin 4 on LCD.
const int dcPin = A5;    // DC - Data/Command, pin 5 on LCD.
const int sdinPin = 23;  // DN(MOSI) - Serial data, pin 6 on LCD.
const int sclkPin = 24;  // SCLK - Serial clock, pin 7 on LCD.
